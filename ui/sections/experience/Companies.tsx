...
function Companies() {
    return (
        <div>
            ...
            <div className='grid md:grid-cols-5 grid-cols-4 p-4 gap-4 mb-10 md:mb-0'>
                {companies.map((company) => (
                    <div key={company.name}>
                        <img className='p-1 hover:scale-110 duration-200 ease-in-out' src={company.logoUrl} alt={company.name} />
