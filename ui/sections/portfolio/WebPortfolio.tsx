    ...
    return (
        ...
        >
            <div className="w-full max-w-screen min-h-screen h-full flex  lg:flex-row overflow-hidden relative">
                ...
                <h1 className="text-white absolute bottom-0 left-0 bg-blue-700  rounded-tr-xl p-4 md:p-6 md:text-base text-xs z-50 hover:scale-105 duration-200 ease-in-out">
