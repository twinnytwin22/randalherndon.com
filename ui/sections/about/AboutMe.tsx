...
//                   <div className="pl-5">     <GradientText text="About Me" /></div>
...
//               </div>
//             </div>
//             <div className="block p-0 col-span-6 lg:items-center w-full px-8 lg:max-w-2xl items-start fmx-auto content-center justify-center ml-2 lg:mt-8 lg:px-4 xl:mr-16 lg:mr-12">
//               <Slider
//                 {...settings}
