...
const AboutMe = () => {
  return (
    <div className="dark:bg-neutral-950 bg-slate-200 mx-auto h-screen relative">
      <div className=" grid grid-cols-6 xl:grid-cols-12 max-w-screen min-h-full place-items-center px-8 ">
      <div className="min-w-full h-full col-span-8 mx-auto ml-2 space-y-6 xl:text-8xl text-5xl sm:text-7xl items-center xl:order-2">
          <div className="md:flex text-center p-4 sm:p-16 items-center min-h-full">
           <GradientText text="About Me"/>
            ...
            <p className="w-full text-xl p-4 sm:p-8 md:pr-16 lg:pr-36 items-center min-h-full text-left">
        ...
        <div className="p-4 md:p-20 col-span-4 items-center w-full xl:order-1">
